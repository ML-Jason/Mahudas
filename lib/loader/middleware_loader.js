...
/**
 * 用來自動載入 middleware 的loader
 * 載入的模組會被注入到app.middleware
 */
...
const run = async (app, startPath) => {
  const scanPath = path.join(startPath || app.appInfo.root, 'app', 'middleware');
